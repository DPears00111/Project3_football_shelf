      ...
      <header class="header">
        ...
        <div class="header-icons">
          <div class="profile-link" style="position: relative;">
            ...
            <div v-if="showDropdown" class="dropdown-menu" style="position: absolute; right: 0; top: 48px; background: white; border: 1px solid #ccc; border-radius: 6px; min-width: 120px; box-shadow: 0 2px 8px rgba(0,0,0,0.15); z-index: 1000;">
  ...
  const router = useRouter();
    ...
    const products = computed(() => {
      ...
      if (selectedLeague.value) {
        // Find all team_ids in the selected league
...
.product-card:hover {
  ...
  background: #f8f8f8; /* Optional: subtle color change */
}
.product-image {
  width: 100%;
  height: 400px;
